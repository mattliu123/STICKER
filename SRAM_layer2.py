...
Input_fmap = np.zeros((IF_CHANNEL, IF_SIZE + 9, IF_SIZE + 9), dtype = int)
...
print("IF DRAM Access data for Layer2 = ",IF_DRAM_access)
print("Weight DRAM Access data for Layer2 = ",W_DRAM_access)
